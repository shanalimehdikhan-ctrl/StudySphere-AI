...
export default function Dashboard({ onOpenTutor }: DashboardProps) {
  const tools = [
    { title: "🤖 AI Tutor", action: onOpenTutor },
    { title: "📄 Notes" },
    { title: "📝 Quiz" },
    { title: "🃏 Flashcards" },
    { title: "🧮 Solve" },
    ...
    <div className="mx-auto max-w-6xl px-6 py-8">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <div className="glass rounded-3xl p-5">
          ...
          <p className="mt-3 text-3xl font-bold text-white">18 Days</p>
        </div>

        <div className="glass rounded-3xl p-5">
          <h3 className="text-slate-400">⭐ Level</h3>
          <p className="mt-3 text-3xl font-bold text-white">Scholar</p>
        </div>

        <div className="glass rounded-3xl p-5">
          <h3 className="text-slate-400">🏆 XP</h3>
          <p className="mt-3 text-3xl font-bold text-white">2450</p>
        </div>

        <div className="glass rounded-3xl p-5">
          <h3 className="text-slate-400">📚 Completed</h3>
          <p className="mt-3 text-3xl font-bold text-white">34 Lessons</p>
        </div>
      </div>
